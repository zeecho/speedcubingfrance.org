...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { iso_code: @region.iso_code, name: @region.name } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { iso_code: @region.iso_code, name: @region.name } }
