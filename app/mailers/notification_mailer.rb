class NotificationMailer < ApplicationMailer
  ...
  def notify_of_new_competition
    ...
    mail(bcc: "adherents-notifications@speedcubingfrance.org", subject: "La compétition #{@competition.name} vient d'être annoncée", from: "contact@speedcubingfrance.org")
  end
