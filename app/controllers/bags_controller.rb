class BagsController < ApplicationController
  ...
  def create
    ...
    if @bag.save
      redirect_to @bag, flash: { success: I18n.t("bags.notif.create") }
    else
      render :new
    end
  end
  ...
  def update
    if @bag.update(bag_params)
      redirect_to @bag, flash: { success: I18n.t("bags.notif.update") }
    else
      render :edit
    end
  end
  ...
  def destroy
    @bag.destroy
    redirect_to bags_url, flash: { success: I18n.t("bags.notif.destroy") }
  end
